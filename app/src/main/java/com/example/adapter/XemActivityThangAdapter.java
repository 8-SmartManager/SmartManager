...
public class XemActivityThangAdapter extends BaseAdapter {
    Context context;
    int item_thuchi;
    List<ThuChiXemActivity> activity;

    public XemActivityThangAdapter(Context context, int item_thuchi, List<ThuChiXemActivity> activity) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        XemActivityThangAdapter.ViewHolder holder;
        if(view == null){
            holder = new XemActivityThangAdapter.ViewHolder();
            ...
            holder = (XemActivityThangAdapter.ViewHolder) view.getTag();
        }
        //binding
