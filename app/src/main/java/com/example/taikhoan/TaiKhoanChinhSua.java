...
import com.example.thongke.fragment.HopChonTKTaiKhoan;
import com.example.thongke.fragment.HopChonTKTheLoaiChi;
import com.example.thongke.fragment.HopChonTheLoaiThu;

import java.text.SimpleDateFormat;
import java.util.Calendar;

public class TaiKhoanChinhSua extends AppCompatActivity {
        ...
        btnLuu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (theLoai.equals("") || taiKhoan.equals("") || money.equals("")){
                    AlertDialog.Builder builder = new AlertDialog.Builder(TaiKhoanChinhSua.this);
        ...
        btnXoa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                btnYes.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        TaiKhoanChiTietActivity.db.execSql("DELETE FROM "+MyDatabaseHelper.TBL_NAME_THUCHI+" WHERE "+MyDatabaseHelper.COL_THUCHI_ID + "=" +selectedThongKeChiTiet.getActivityId());
                        finish();
                    }
                });
    ...
    View.OnClickListener myClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == R.id.txtTKNgay){
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(TaiKhoanChinhSua.this,callBack,
