...
public class TaiKhoanAdapter extends BaseAdapter {
    Activity context;
    int item_listview;
    List<TaiKhoanActivity> taiKhoanList;
    public TaiKhoanAdapter(Activity context, int item_listview, List<TaiKhoanActivity> taiKhoanList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        //Binding data
        TaiKhoanActivity t = taiKhoanList.get(i);
